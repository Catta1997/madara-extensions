...
//#endregion
//#region src/MangaReadOrg/parsers.ts
	var MangaReadOrgParser = class extends MadaraParser {
		constructor(..._args) {
			super(..._args);
			_defineProperty(this, "parseDate", (dateString) => {
				const [day, month, year] = dateString.split(".").map(Number);
				const parseDate = new Date(year, month - 1, day);
				if (parseDate.getFullYear() == year) return parseDate;
...
//#endregion
//#region src/MangaReadOrg/pbconfig.ts
...
//#endregion
//#region src/MangaReadOrg/main.ts
	...
	const MangaReadOrg = new MangaReadOrgExtension();
...
//# sourceMappingURL=MangaReadOrg.js.map