...
//#endregion
//#region src/PlatinumScans/pbconfig.ts
...
//#endregion
//#region src/PlatinumScans/main.ts
	...
	const PlatinumScans = new PlatinumScansExtension();
...
//#endregion
//#region src/tests/PlatinumScans.ts
	async function runTests(logger) {
		const suite = new TestSuite("PlatinumScans tests", logger);
		registerDefaultTests(suite, PlatinumScans, pbConfig);
		await suite.run();
	}
...
//# sourceMappingURL=PlatinumScans.js.map