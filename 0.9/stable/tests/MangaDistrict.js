...
//#endregion
//#region src/MangaDistrict/pbconfig.ts
...
//#endregion
//#region src/MangaDistrict/main.ts
	const DOMAIN = "https://mangadistrict.com";
	var MangaDistrictExtension = class extends MadaraGeneric {
		constructor() {
			super({
				domain: DOMAIN,
				name: pbConfig.name,
	...
	const MangaDistrict = new MangaDistrictExtension();
...
//#endregion
//#region src/tests/MangaDistrict.ts
	async function runTests(logger) {
		const suite = new TestSuite("MangaDistrict tests", logger);
		registerDefaultTests(suite, MangaDistrict, pbConfig);
		await suite.run();
	}
...
//# sourceMappingURL=MangaDistrict.js.map