...
//#endregion
//#region src/MangaScantrad/pbconfig.ts
	...
	pbConfig.contentRating = ContentRating$1.MATURE;

//#endregion
//#region src/MangaScantrad/main.ts
	...
	const MangaScantrad = new MangaScantradExtension();
...
//#endregion
//#region src/tests/MangaScantrad.ts
	async function runTests(logger) {
		const suite = new TestSuite("MangaScantrad tests", logger);
		registerDefaultTests(suite, MangaScantrad, pbConfig);
		await suite.run();
	}
...
//# sourceMappingURL=MangaScantrad.js.map