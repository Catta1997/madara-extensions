...
//#endregion
//#region src/MangaOrigines/pbconfig.ts
...
//#endregion
//#region src/MangaOrigines/main.ts
	...
	const MangaOrigines = new MangaOriginesExtension();
...
//#endregion
//#region src/tests/MangaOrigines.ts
	async function runTests(logger) {
		const suite = new TestSuite("MangaOrigines tests", logger);
		registerDefaultTests(suite, MangaOrigines, pbConfig);
		await suite.run();
	}
...
//# sourceMappingURL=MangaOrigines.js.map