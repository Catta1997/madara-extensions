...
//#endregion
//#region src/LHTranslation/pbconfig.ts
...
//#endregion
//#region src/LHTranslation/main.ts
	...
	const LHTranslation = new LHTranslationExtension();
...
//#endregion
//#region src/tests/LHTranslation.ts
	async function runTests(logger) {
		const suite = new TestSuite("LHTranslation tests", logger);
		registerDefaultTests(suite, LHTranslation, pbConfig);
		await suite.run();
	}
...
//# sourceMappingURL=LHTranslation.js.map